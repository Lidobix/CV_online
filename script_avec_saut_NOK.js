...
$(function () {
  ...
  var monJeu = {
    ...
    mouvementHorizontal: function (position, increment) {
      ...
      //////////////////////////////////////////////////////////////////////////////////
      if (position == "saut") {
        // this.directions.etatInitial = false;
        
        console.log("demande de saut ");
        ...
        var saut = function () {
          ...
          var z =
            ...
            (-0.5 *
              ...
              x * Math.tan(angle));
          console.log(" dans le calcul de l'équation : x =", x, " , z= ", z);
      ...
      ////////////////////////////////////////////////////////////////////////////////////
      if (increment != NaN && position != "saut") {
    ...
    leMoteurPourLesAnimations: function () {
      ...
      if (this.directions.haut) {
        ...
        this.detectionObstacle();
        // console.log(this.directions.etatInitial)
        this.mouvementHorizontal("saut", NaN);
        
        
        
        // if (!sautEnCours) {this.directions.etatInitial = true};
    ...
    start: function () {
      ...
      window.addEventListener("keyup", function (event) {
        ...
        // if (introDuJeu || ici.directions.droite ||  ici.directions.gauche ||  !ici.directions.haut ||
        //   ici.directions.action || ici.directions.coup  || sautPanneau){ ici.directions.etatInitial = false;

        //   } else {ici.directions.etatInitial = true;}
        // if (sortiePanneauEnCours) {ici.directions.etatInitial = false};
        ...
        switch (codeTouche) {
          ...
          case 38:
            ...
            if (!introDuJeu && !ici.directions.droite &&  !ici.directions.gauche &&
              !ici.directions.action &&
              !ici.directions.coup 
              ...
              if (chronoIntro > delaiFinIntro) {
                ...
                var sautPanneau = setInterval(function () {
                  ...
                  $sprite.css({
                    ...
                    width: interpos[17].sprite.width,
                  });
...
// if (!sortiePanneauEnCours){
     ...
     if (introDuJeu || ici.directions.droite ||  ici.directions.gauche ||  !ici.directions.haut ||
          ici.directions.action || ici.directions.coup  || sortiePanneauEnCours){ ici.directions.etatInitial = false;
